 ...
 * @author julie
 */
@WebServlet(name = "ServletSupprimerElementPanier", urlPatterns = {"/ServletSupprimerElementPanier"})
public class ServletSupprimerElementPanier extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        for (int i = 0; i < listePanier.size(); i++){
            if (listePanier.get(i).getId_produit() == id_produit){
