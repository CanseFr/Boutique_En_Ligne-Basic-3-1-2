 ...
 * @author julie
 */
@WebServlet(name = "ServletAfficherProduitEnStock", urlPatterns = {"/ServletAfficherProduitEnStock"})
public class ServletAfficherProduitEnStock extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ServletAfficherProduitEnStock.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
